...
[![CI](https://github.com/dsantoreis/ironflow/actions/workflows/ci.yml/badge.svg)](https://github.com/dsantoreis/ironflow/actions/workflows/ci.yml) [![Coverage >= 80%](https://img.shields.io/badge/coverage-80%25%2B-success)](#) [![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](./LICENSE)
...
Coverage is gated at **80% minimum**.
